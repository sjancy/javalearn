...
public class MenuRunner {
	...
	public static void main(String[] args) {
		...
		performanceUsingNestedIfElse(number1, number2, choice);// how i did was right click select Refactor then select Extract Method
	}

	private static void performanceUsingNestedIfElse(int number1, int number2, int choice) {
		if(choice==1) {
